  ...
  return (
    <div className="min-h-screen bg-navy-50">
      ...
      <main className="mx-auto max-w-5xl px-4 py-6 space-y-6">
        {/* Today's summary */}
        <section className="rounded-2xl bg-linear-to-r from-navy-800 to-teal-600 p-5 text-white">
                    ...
                    {visibleDates.map (d => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex flex-col items-center justify-center rounded-xl border px-3 py-2.5 min-w-15 transition-all ${
                            isSelected
